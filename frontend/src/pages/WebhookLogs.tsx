      ...
      <Card hover={false} className="!p-0">
        {logs.isLoading ? (
          ...
          <div className="p-12 text-center">
            ...
            <div className="text-sm font-medium text-slate-700 dark:text-slate-200">No webhooks yet</div>
            <div className="text-xs text-slate-400 dark:text-slate-500 mt-1 max-w-[360px] mx-auto leading-relaxed">
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          {log.parse_error && (
            <div className="text-xs text-rose-600 dark:text-rose-300 mt-0.5 truncate">parse error: {log.parse_error}</div>
          )}
        </div>
      </button>
